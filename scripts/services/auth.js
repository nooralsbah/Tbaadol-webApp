...
app.factory('Auth', function(FURL, $firebaseAuth, $firebase) {
    ...
    var Auth = {
        ...
        register: function(user) {
            return auth.$creatUser({email: user.email, password: user.password})
                .then(function() {
        ...
        changePassword: function(user) {
            return auth.$changePassword({email: user.email,
                olsPassword: user.oldPass, newPassword: user.newPass});
        },
        signedIn: function() {
